...
At the time of writing this post [gatsby-remark-sticky-table](https://github.com/PaulieScanlon/gatsby-remark-sticky-table) is still very much experimental, it is functional and has had mild testing.
...
Well that's what i thought at first, until i started reading about [remark](https://github.com/remarkjs/remark) and [unist-util-visit](https://github.com/syntax-tree/unist-util-visit) which give me a better understanding of how markdown gets transformed into HTML.

I then stumbled upon this great little tutorial [https://www.gatsbyjs.org/docs/remark-plugin-tutorial/](https://www.gatsbyjs.org/docs/remark-plugin-tutorial/) in short what it shows is how to grab references to nodes from markdown and then modify them before passing them back as HTML
...
This in short is how i've created [gatsby-remark-sticky-table](https://github.com/PaulieScanlon/gatsby-remark-sticky-table).
...
I'd really appreciate issues, comments or stars on [Github](https://github.com/PaulieScanlon/gatsby-remark-sticky-table) so if you are using this plugin in your project please do let me know what you think [@pauliescanlon](https://twitter.com/PaulieScanlon)
